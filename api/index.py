...
try:
    from api.rumus_1 import hitung_rumus_satu
except ImportError:
    from rumus_1 import hitung_rumus_satu

app = Flask(__name__, template_folder='../templates')
app.secret_key = "MAMANG2026"
...
def analyze():
    ...
    all_res = fetch_results(code) # Pastikan fungsi fetch_results ada di index.py ini

    if rumus_type == "rumus_1":
        # Jalankan Rumus 1
        return jsonify(hitung_rumus_satu(market, all_res))
    else:
        # Jalankan Rumus Default (Hybrid V3)
